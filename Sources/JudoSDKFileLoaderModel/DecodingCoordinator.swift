...
public final class DecodingCoordinator {
    ...
    public init(documentVersion: Int, stringTable: StringTable, images: Set<ImageValue>, mediaURLs: Set<URL>, fontURLs: Set<URL>) {
